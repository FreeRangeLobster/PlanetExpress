...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DataAnnotations1
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DataAnnotations1))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201802071359058_DataAnnotations1"
            End Get
        End Property
