...
Namespace Migrations
    ...
    Public NotInheritable Partial Class DataAnnotations2
        Implements IMigrationMetadata
    
        Private ReadOnly Resources As New ResourceManager(GetType(DataAnnotations2))
        
        Private ReadOnly Property IMigrationMetadata_Id() As String Implements IMigrationMetadata.Id
            Get
                Return "201802071400571_DataAnnotations2"
            End Get
        End Property
